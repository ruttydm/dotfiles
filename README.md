...
- `hypr` — Omarchy-only Hyprland overrides: agent/Ghostty touchpad scroll, plus the X1 Carbon dock layout (HDMI Philips left, USB-C Dell primary in the middle, laptop right at scale 1.25).
